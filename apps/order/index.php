...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>Orders <small>incomplete</small></h2>
      ...
      <table id="datatable" class="table">
        ...
        <tbody>
          ...
          $query = $db->prepare("SELECT * FROM tb_order INNER JOIN tb_member ON tb_order.id_member=tb_member.id_member
                                 ...
                                 WHERE tb_order.status < 4 ORDER BY id_order DESC;");//เตรียมคำสั่ง sql
          ...
          <tr>
            ...
            <td>
              ...
              <a data-toggle="tooltip" data-placement="top" title="Delete" href="home.php?file=order/delete&id=<?=$row->id_order?>">
