      ...
      if (move_uploaded_file($_FILES["image"]["tmp_name"], $path_copy)) {
          //echo "The file ". basename( $_FILES["image"]["name"]). " has been uploaded.";
            ...
            $query = $db->prepare("INSERT INTO tb_food (
              food_name, type, 	price, food_pic, cp_foodpic
            ) VALUES (
              :food, :type, :price, :image, :cp_foodpic
            );");
...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      <a data-toggle="tooltip" data-placement="top" title="View All" href="home.php?file=food/index">
