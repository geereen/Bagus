    ...
    <div class="x_content">
      <table id="datatable" class="table">
        <thead>
          <tr>
            <th>
              <a data-toggle="tooltip" data-placement="top" title="Add" href="home.php?file=food/add">
        ...
        ?>
          <tr>
            ...
            <td><?= $row->price;?></td>
            <td>
              <a data-toggle="tooltip" data-placement="top" title="View" href="home.php?file=food/view&id=<?=$row->id_food?>">
  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      <table id="datatable" class="table">
        ...
        <tbody>
        <?php
          $query = $db->prepare("SELECT * FROM tb_food ORDER BY id_food ASC");//เตรียมคำสั่ง sql
